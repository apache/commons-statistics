...
@Command(name = "logistic",
         ...
         subcommands = {
             LogisticCommand.Info.class,
             LogisticCommand.Sample.class,
...
class LogisticCommand extends AbstractDistributionCommand {
    ...
    private abstract static class BaseCommand extends AbstractContinuousDistributionCommand {
        ...
        protected List<Distribution<ContinuousDistribution>> getDistributions() {
            ...
            for (int i = 0; i < n; i++) {
                final ContinuousDistribution d = LogisticDistribution.of(location[i], scale[i]);
    ...
    /** Information command. */
    @Command(name = "info",
             description = "Logistic distribution information.")
    ...
    /** Information command. */
    @Command(name = "sample",
             description = "Logistic distribution sample.")
