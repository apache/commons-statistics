...
import org.apache.commons.statistics.core.LocalizedFormats;
...
public final class IntervalUtils {
     ...
     * @throws IllegalArgumentException if {@code numberOfTrials <= 0}.
     * @throws IllegalArgumentException if {@code numberOfSuccesses < 0}.
     * @throws IllegalArgumentException if {@code numberOfSuccesses > numberOfTrials}.
     * @throws IllegalArgumentException if {@code confidenceLevel} is not in the interval {@code (0, 1)}.
     */
    ...
    static void checkParameters(int numberOfTrials, int numberOfSuccesses, double confidenceLevel) {
        if (numberOfTrials <= 0) {
           throw new IllegalArgumentException("Number of Trails must be Positive");
        }
