...
final class SumOfFourthDeviationsWrapper implements
     ...
     */
    SumOfFourthDeviationsWrapper(SumOfFourthDeviations sq) {
        delegate = sq;
    }
    ...
    public double getAsDouble() {
        return delegate.getSumOfFourthDeviations();
    }

    @Override
    public SumOfFourthDeviationsWrapper combine(SumOfFourthDeviationsWrapper other) {
