 ...
 * This supports testing statistics that implement {@link IntStatistic} and
 ...
 *
 * <ol>
 *  <li>{@link java.util.function.IntConsumer#accept accept}
 *  <li>{@link java.util.function.IntConsumer#accept accept} and
 ...
 *  <li>{@link #getExpectedValue(int[])}: A method to compute an expected value for the
...
abstract class BaseIntStatisticTest<S extends IntStatistic & StatisticAccumulator<S>>
    ...
    private static final int[] V1 = {20, 8, 1, 2, 24, -13, -1, 19, 0, 23, 14, 2, -9, 0, 7, -15, -2, -9, -1, 12, -12,
    ...
    private static final int[] V2 = {3, 0, 3, 4, 0, 1, 1, 3, 2, 1, 3, 1, 5, 0, 0, 0, 3, 3, 2, 0, 3, 1, 2, 1, 1, 0, 0,
    ...
    private static final int[] V3 = {1, 5, 5, 2, 1, 7, 5, 5, 3, 5, 5, 2, 4, 4, 6, 2, 7, 5, 3, 6, 7, 3, 5, 3, 7, 6, 4,
    ...
    private static final int[] V4 = {42, 51, 38, 38, 49, 48, 42, 47, 51, 46, 45, 35, 39, 42, 49, 55, 53, 46, 49, 56,
    ...
    /** Sizes to cut the sample data into chunks. The {@link #cut(int[], int...)} method is robust
    ...
    private static class TestData {
         ...
         */
        TestData(int[] values, StatisticResult expected) {
            this.values = values;
    ...
    static class StatisticTestData extends TestData {
         ...
         * @param expected Expected statistic value.
         */
        StatisticTestData(int[] values, StatisticResult expected) {
         ...
         */
        StatisticTestData(int[] values, StatisticResult expected, DoubleTolerance tol) {
         ...
         * {@link BaseIntStatisticTest#testAccept(int[], StatisticResult, DoubleTolerance)}
         * method.
         *
        ...
        /**
         * Gets the tolerance for the
         * {@link BaseIntStatisticTest#testArray(int[], StatisticResult, DoubleTolerance)
         * )} method.
         *
         * @return the tolerance
         */
        ...
        /**
         * Gets the tolerance for the
         * {@link BaseIntStatisticTest#testAcceptAndCombine(int[][], StatisticResult, DoubleTolerance)}
         * method.
         *
         * @return the tolerance
         */
        ...
        /**
         * Gets the tolerance for the
         * {@link BaseIntStatisticTest#testArrayAndCombine(int[][], StatisticResult, DoubleTolerance)}
         * method.
         *
         * @return the tolerance
         */
    ...
    void setup() {
        ...
        Stream.of(V1, V2, V3, V4).forEach(values -> {
            final int[] sample = new int[values.length];
     ...
     * @return the statistic
     */
    protected abstract S create(int... values);
     ...
     * @return the statistic
     */
    protected abstract S create(int[] values, int from, int to);

    /**
     * Map the {@code value} to the valid domain of the statistic. This method is called
     * with the example data before {@link #getExpectedValue(int[])}. It can be used by
     ...
     */
    protected abstract StatisticResult getExpectedValue(int[] values);
     ...
     */
    final StatisticTestData addReference(int expected, int... values) {
     ...
     * @return the statistic test data
     */
    final StatisticTestData addReference(long expected, int... values) {
     ...
     * @return the statistic test data
     */
    final StatisticTestData addReference(BigInteger expected, int... values) {
     ...
     */
    StatisticTestData addReference(double expected, int... values) {
     ...
     * @return the statistic test data
     */
    final StatisticTestData addReference(double expected, DoubleTolerance tol, int... values) {
        Assertions.assertEquals(ResultType.DOUBLE, getResultType());
     ...
     * @param values Values.
     * @return the statistic test data
     * @see #getExpectedValue(int[])
     * @see #getToleranceAccept()
     * @see #getToleranceArray()
     * @see #getToleranceAcceptAndCombine()
     * @see #getToleranceArrayAndCombine()
     */
    final StatisticTestData addCase(int... values) {
     ...
     * The expected value will be computed using {@link #getExpectedValue(int[])}.
     *
     * <p>This method can be used to add data to target specific edge cases.
     *
     * <p>Note: Throws an exception if {@link #getResultType()} is not {@code double}.
     ...
     * @return the statistic test data
     */
    final StatisticTestData addCase(DoubleTolerance tol, int... values) {
        Assertions.assertEquals(ResultType.DOUBLE, getResultType());
     ...
     * {@link java.util.function.IntConsumer#accept accept} method. The expected value
    ...
    /**
     * Stream the arguments to test the computation of the statistic using the
     * {@link #create(int[], int, int)} method. The expected value is the same as
     * using the {@link #create(int...)} method with the values from
     * {@link Arrays#copyOfRange(int[], int, int)}.
     *
     * @return the stream
     */
    final Stream<int[]> testArrayRange() {
        final Builder<int[]> b = Stream.builder();
    ...
    /**
     * Stream the arguments to test the computation of the statistic using the
     * {@link java.util.function.IntConsumer#accept(int) accept} method for each
     ...
     * @return the set of arrays
     */
    private static int[][] split(int[] data, int groups) {
        ...
        final int[][] values = new int[groups][];
    ...
    final void testEmptyArrayRange() {
        assertEmpty(create(new int[10], 2, 2), getToleranceArray());
    }
     ...
     * {@link java.util.function.IntConsumer#accept(int) accept} method. The
    ...
    @ParameterizedTest
    @MethodSource
    final void testAccept(int[] values, StatisticResult expected, DoubleTolerance tol) {
    ...
    @ParameterizedTest
    @MethodSource
    final void testArray(int[] values, StatisticResult expected, DoubleTolerance tol) {
        assertStatistic(this::create, values, expected, tol);
    }

    /**
     * Test the computation of the statistic using the {@link #create(int[], int, int)} method.
     */
    @ParameterizedTest
    @MethodSource
    final void testArrayRange(int[] values) {
    ...
    /**
     * Test the {@link #create(int[], int, int)} method throws with an invalid range.
     */
    @ParameterizedTest
    ...
    @ParameterizedTest
    @MethodSource
    final void testAcceptAndCombine(int[][] values, StatisticResult expected, DoubleTolerance tol) {
    ...
    @ParameterizedTest
    @MethodSource
    final void testArrayAndCombine(int[][] values, StatisticResult expected, DoubleTolerance tol) {
    ...
    @ParameterizedTest
    @MethodSource(value = "testAccept")
    final void testEmptyCombine(int[] values) {
    ...
    @ParameterizedTest
    @MethodSource(value = "testAccept")
    final void testCombineEmpty(int[] values) {
        final S empty = create();
        final S nonEmpty = Statistics.add(create(), values);
        final StatisticResult expected = Statistics.add(create(), values);
     ...
     * {@link #testAcceptAndCombine(int[][], StatisticResult, DoubleTolerance)} method and uses
    ...
    /**
     * Test the computation of the statistic using a parallel stream of {@code int[]}
     * arrays. The arrays are mapped to a statistic using the {@link #create(int...)}
     * method, and the stream reduced using the
     * {@link StatisticAccumulator#combine(StatisticResult) combine} method.
     *
     * <p>Note: This method is similar to the
     * {@link #testArrayAndCombine(int[][], StatisticResult, DoubleTolerance)} method and uses
    ...
    final void testArrayParallelStream(int[][] values, StatisticResult expected, DoubleTolerance tol) {
        final S actual = Arrays.stream(values)
            .parallel()
            .map(this::create)
    ...
    /**
     * Invokes the {@link #testAccept(int[], StatisticResult, DoubleTolerance)} method using
     * random permutations of the data.
     */
    @ParameterizedTest
    @MethodSource(value = "testAccept")
    final void testAcceptRandom(int[] values, StatisticResult expected, DoubleTolerance tol) {
    ...
    /**
     * Invokes the {@link #testArray(int[], StatisticResult, DoubleTolerance)} method using
     * random permutations of the data.
     */
    @ParameterizedTest
    @MethodSource(value = "testArray")
    final void testArrayRandom(int[] values, StatisticResult expected, DoubleTolerance tol) {
        // Obtain a seed so that it can be logged to allow repeats
        final long[] seed = TestHelper.createRNGSeed();
        final UniformRandomProvider rng = TestHelper.createRNG(seed);
        int repeat = 0;
    ...
    /**
     * Invokes the {@link #testAcceptAndCombine(int[][], StatisticResult, DoubleTolerance)} method using
     * random permutations of the data.
     */
    @ParameterizedTest
    @MethodSource(value = "testAcceptAndCombine")
    final void testAcceptAndCombineRandom(int[][] values, StatisticResult expected, DoubleTolerance tol) {
        // Obtain a seed so that it can be logged to allow repeats
        final long[] seed = TestHelper.createRNGSeed();
        final UniformRandomProvider rng = TestHelper.createRNG(seed);
        final int[] allValues = TestHelper.concatenate(values);
        int repeat = 0;
        try {
            while (repeat++ < RANDOM_PERMUTATIONS) {
    ...
    /**
     * Invokes the {@link #testArrayAndCombine(int[][], StatisticResult, DoubleTolerance)} method using
     * random permutations of the data.
     */
    @ParameterizedTest
    @MethodSource(value = "testArrayAndCombine")
    final void testArrayAndCombineRandom(int[][] values, StatisticResult expected, DoubleTolerance tol) {
        // Obtain a seed so that it can be logged to allow repeats
        final long[] seed = TestHelper.createRNGSeed();
        final UniformRandomProvider rng = TestHelper.createRNG(seed);
        final int[] allValues = TestHelper.concatenate(values);
    ...
    @ParameterizedTest
    @MethodSource(value = "testAccept")
    final void testCombineAsAccept(int[] values, StatisticResult expected, DoubleTolerance tol) {
        final S empty = create();
        assertStatistic(v ->
     ...
     */
    final S assertStatistic(Function<int[], S> constructor,
                            int[] values, StatisticResult expected, DoubleTolerance tol) {
     ...
     * @param to Exclusive end of the range.
     */
    final void assertStatistic(int[] values, int from, int to) {
     ...
     * @return the computed statistic
     */
    final S assertCombine(Function<int[], S> constructor,
                          int[][] values, StatisticResult expected, DoubleTolerance tol) {
        int n = values.length;
