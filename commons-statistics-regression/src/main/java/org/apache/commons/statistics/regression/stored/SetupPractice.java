...
//      RegressionDataLoader loader = new RegressionDataLoader(yData, xData);

//      double[] yData = { 10, 20, 30 };
//      double[][] xData = { { 11, 12, 13 }, { 21, 22, 23 }, { 31, 32, 33 } };
//      printArray2D(xData);
//      printArrayWithStreams(yData);
//      printArrayWithStreams(xData);
...
//        OLSRegression ols = new OLSRegression(loader);
//        loader.newYData(yData);
